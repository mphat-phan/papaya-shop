          ...
          <Grid item xs={12} lg={8}>
            <List>
              <ListItem divider>
                ...
                <ListItemText primary='Địa điểm giao hàng' secondary={address} />
              </ListItem>
              <ListItem divider>
                <ListItemIcon>
                ...
                />
                {cart.paymentMethod == "Paypal" ? (<ListItemAvatar>
            ...
            <Paper elevation={0} className={classes.cartTotalWrapper}>
              ...
              <List style={{ padding: '10px 20px 20px' }}>
                <ListItem divider disableGutters>
                  ...
                  <Typography>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(cart.itemsPrice)}</Typography>
                </ListItem>
                <ListItem divider disableGutters>
                  <ListItemText primary='Phí giao hàng:' />
                  <Typography>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(cart.shippingPrice)}</Typography>
                </ListItem>
                <ListItem divider disableGutters>
                  <ListItemText primary='Thuế:' />
                  <Typography>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(cart.taxPrice)}</Typography>
                </ListItem>
                <ListItem disableGutters>
                  <ListItemText primary='Tổng cộng:' />
                  <Typography color='secondary'>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(cart.totalPrice)}</Typography>
                </ListItem>
              </List>
