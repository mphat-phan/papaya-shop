...
const ProfileScreen = ({ history }) => {
  ...
  const removeAvatar = () =>{
    if(avatar !== null){
      setAvatar("https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg")
    }
  }
  console.log(avatar)
  ...
  const submitHandler = ({ name, email, password, address, city, postalCode, country }) => {
    dispatch(updateUserProfile({ id: user._id, name, email, password, avatar, address, city, postalCode, country }));
  };
            ...
            {loading ? (
              ...
              <>
                <Box className={classes.profile}>
                  ...
                  >
                     <label className={classes.labelButton} htmlFor="raised-button-file">
                      {
                        avatar === "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg" || user.avatar === "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg" ? (
                          <Avatar
                ...
                <Typography>
                    ...
                    />
                    {
                     avatar !== "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg" && avatar !== null ? (
                      <Button
                        variant='contained'
                        color='secondary'
                        startIcon={<MdClose />}
                ...
                <TableBody>
                  {orders.map((order) => (
                    <TableRow key={order._id}>
                      ...
                      <TableCell align='right'>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'VND' }).format(order.totalPrice)}</TableCell>
                      <TableCell align='right'>
                        {order.paidAt ? (
