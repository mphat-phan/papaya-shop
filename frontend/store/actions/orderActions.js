...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${settings.serverHost}/api/orders`, order, config);
  ...
  try {
    ...
    await Promise.all(
      year.map(async(label) => {
        ...
        var {data} = await axios.get(`${settings.serverHost}/api/orders/revenue/deliveredAt/${label}`, config);
        data.map((elm) => {
...
export const getSellingProduct = (top, year, month) => async(dispatch, getState) => {
  try {
    ...
    var { data } = await axios.get(`${settings.serverHost}/api/orders/${top}/sellingProducts/${year}/${month}`, config);
    dispatch({
...
export const getOrderById = (id) => async (dispatch, getState) => {
  try {
    ...
    var { data } = await axios.get(`${settings.serverHost}/api/orders/${id}`, config);
...
export const payOrder = (orderId, paymentResult) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(
        `${settings.serverHost}/api/orders/${orderId}/pay`,
        paymentResult,
        config
      );
...
export const deliverOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${settings.serverHost}/api/orders/${order._id}/deliver`,
      {},
      config
    );
...
export const cancelOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${settings.serverHost}/api/orders/${order._id}/cancel`,
      {},
      config
    );
...
export const confirmOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${settings.serverHost}/api/orders/${order._id}/confirm`,
      {},
      config
    );
...
export const deliveringOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${settings.serverHost}/api/orders/${order._id}/delivering`,
      {},
      config
    );
...
export const listMyOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${settings.serverHost}/api/orders/myorders`, config);
...
export const listOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${settings.serverHost}/api/orders`, config);
