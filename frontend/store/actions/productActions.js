  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${settings.serverHost}/api/products?keyword=${keyword}&pageNumber=${pageNumber}&option=${option}`
      );
...
export const fetchProductDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${settings.serverHost}/api/products/${id}`);
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${settings.serverHost}/api/products/${id}`, config);
...
export const createProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${settings.serverHost}/api/products`, product, config);
...
export const updateProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${settings.serverHost}/api/products/${product._id}`,
      product,
      config
    );
...
export const createProductReview = (productId, review) => async (dispatch, getState) => {
    try {
      ...
      await axios.post(`${settings.serverHost}/api/products/${productId}/reviews`, review, config);
...
export const createProductComment = (productId, comment) => async (dispatch, getState) => {
  try {
    ...
    await axios.post(`${settings.serverHost}/api/products/${productId}/comments`, comment, config);
...
export const createCommentReply = (productId,commentId, avatar, reply) => async (dispatch, getState) => {
  try {
    ...
    await axios.post(`${settings.serverHost}/api/products/${productId}/reply`, {commentId, reply, avatar}, config);
...
export const createCommentReviewReply = (productId, reviewId, reply) => async (dispatch, getState) => {
  try {
    ...
    await axios.post(`${settings.serverHost}/api/products/${productId}/reply/reviews`, {reviewId, reply}, config);
...
export const listTopProducts = (pageNumber = '', perPage = '') => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${settings.serverHost}/api/products/top?pageNumber=${pageNumber}&perPage=${perPage}`
      );
...
export const listLatestProducts = (pageNumber) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${settings.serverHost}/api/products/latest?pageNumber=${pageNumber}`
    );
...
export const listSaleProducts = (pageNumber) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${settings.serverHost}/api/products/sale?pageNumber=${pageNumber}`
    );
...
export const listRelatedProducts = (category) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${settings.serverHost}/api/products/related?category=${category}`
    );
...
export const listSortByPriceProducts = (sortBy, pageNumber) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${settings.serverHost}/api/products/price?sortBy=${sortBy}&pageNumber=${pageNumber}`
      );
